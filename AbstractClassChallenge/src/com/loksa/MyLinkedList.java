...
//you can also use recursive method with linkedList but it does not go well with the linkedList because of the depth of the recursive method (stack will overflow). It goes will with searchTree(binary tree) because 63 level can have 9*10^18 nodes
//        if (root != null) {
//            System.out.println(root.getValue());
//            traverse(root.next());
        }
